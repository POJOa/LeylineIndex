...
var maps_api_loader_1 = __webpack_require__(377);
/**
...
var core_1 = __webpack_require__(10);
var Observable_1 = __webpack_require__(7);
var google_maps_api_wrapper_1 = __webpack_require__(371);
...
var core_1 = __webpack_require__(10);
var info_window_manager_1 = __webpack_require__(390);
var infoWindowId = 0;
/**
...
var core_1 = __webpack_require__(10);
var google_maps_api_wrapper_1 = __webpack_require__(371);
var marker_manager_1 = __webpack_require__(376);
...
var core_1 = __webpack_require__(10);
var browser_globals_1 = __webpack_require__(433);
var maps_api_loader_1 = __webpack_require__(377);
...
var core_1 = __webpack_require__(10);
var circle_manager_1 = __webpack_require__(389);
...
var core_1 = __webpack_require__(10);
var kml_layer_manager_1 = __webpack_require__(391);
var layerId = 0;
...
var core_1 = __webpack_require__(10);
var polygon_manager_1 = __webpack_require__(392);
/**
...
var core_1 = __webpack_require__(10);
var polyline_manager_1 = __webpack_require__(393);
var google_map_polyline_point_1 = __webpack_require__(388);
var polylineId = 0;
/**
...
var ng2_bootstrap_2 = __webpack_require__(403);
var app_truncate_util_1 = __webpack_require__(426);
var gallery_component_1 = __webpack_require__(597);
var core_2 = __webpack_require__(611);
...
ExtraModule = __decorate([
    core_1.NgModule({
        declarations: [
            ...
            app_truncate_util_1.TruncatePipe
        ],
        imports: [
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(10);
var gallery_service_1 = __webpack_require__(598);
var app_truncate_util_1 = __webpack_require__(426);
var Gallery = (function () {
    function Gallery(galleryService) {
        ...
        this.activeGroup = '全部';
        this.activeDomain = '全部域名';
        this.activeOwned = '全部';
        this.order = '正序';
        this.currentPage = 0;
        this.getSitesByGroupAndPage(this.activeGroup, this.currentPage);
    }
    ...
    Gallery.prototype.sortSelected = function (isAscend) {
        //this.shuffle.filter(group);
        if (isAscend == '正序') {
            this.order = '正序';
            isAscend = 1;
        ...
        this.getSitesBySort(isAscend);
    };
    Gallery.prototype.activeDomainSelected = function (domain) {
        //this.shuffle.filter(group);
        this.currentPage = 0;
        this.activeDomain = domain;
        this.domLists = [];
        if (domain == '经典域名') {
            this.domLists = ['.com', '.net', '.cn'];
        }
        else if (domain == '流行个人域名') {
            this.domLists = ['.me', '.im', '.cc', '.io'];
        }
        else if (domain == '萌域名') {
            this.domLists = ['.moe'];
        }
        else if (domain == '其他域名') {
            this.domLists = ['others', '.com', '.net', '.cn', '.moe', '.me', '.im', '.cc', '.io'];
        }
        else {
            this.domLists = null;
        }
        this.getSitesByDomain(this.domLists);
    };
    Gallery.prototype.activeOwnedSelected = function (owned) {
        //this.shuffle.filter(group);
        this.currentPage = 0;
        this.activeOwned = owned;
        if (owned == '已认领') {
            this.owned = true;
        }
        else {
        ...
        this.getSitesByOwned(this.owned);
    };
    ...
    Gallery.prototype.deleteSite = function (item) {
        this.galleryService.deleteSite(item._id.$oid).then(this.items.splice(this.items.findIndex(function (i) { return i._id === item._id; }), 1));
    };
    Gallery.prototype.addGroup = function (item, group) {
        var updateData = { $push: { groups: group } };
        this.galleryService.postSite(item._id.$oid, updateData).then(this.items.splice(this.items.findIndex(function (i) { return i._id === item._id; }), 1));
    };
    Gallery.prototype.ngOnInit = function () {
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                _this.activeGroupSelected('个站');
            });
        });
    };
    Gallery.prototype.getPage = function (page) {
        if (page < 0 || page > this.maxPage)
            return;
        this.getSitesByGroupAndPage(this.activeGroup, page);
    };
    Gallery.prototype.getSitesByGroupAndPage = function (group, page) {
        this.query.groups = group;
        this.query.page = page;
        this.doQuery(this.query);
    };
    Gallery.prototype.getSitesByDomain = function (domList) {
        this.query.domain = domList;
        this.query.page = 0;
        this.doQuery(this.query);
    };
    Gallery.prototype.getSitesByOwned = function (owned) {
        this.query.owned = owned;
        this.query.page = 0;
        this.doQuery(this.query);
    };
    Gallery.prototype.getSitesBySort = function (isAscend) {
        this.query.sort = [{ "_id": isAscend }];
        this.doQuery(this.query);
    };
    Gallery.prototype.doQuery = function (query) {
        var _this = this;
        this.galleryService.query(query).then(function (r) {
            _this.items = r.res;
            _this.currentPage = query.page;
            _this.maxPage = r.pages;
            _this.currentRange = Array(_this.maxPage).fill().map(function (x, i) { return i; });
        });
    };
    return Gallery;
}());
Gallery = __decorate([
    core_1.Component({
        ...
        pipes: [app_truncate_util_1.TruncatePipe],
...
var angular2_jwt_1 = __webpack_require__(369);
var GalleryService = GalleryService_1 = (function () {
    function GalleryService(http, noneAuthHttp) {
        this.http = http;
        this.searchUrl = 'http://localhost:5000/sites/search';
        this.pageSize = 12;
        this.deleteUrl = 'http://localhost:5000/site/';
        this.postUrl = 'http://localhost:5000/site/';
    }
    GalleryService.prototype.query = function (query) {
        if (query == null)
            query = {};
        ...
        return this.http.post(this.searchUrl, query)
            ...
            .catch(GalleryService_1.handleError);
    };
    GalleryService.prototype.postSite = function (id, updateData) {
        return this.http.post(this.postUrl + id.toString(), updateData)
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(GalleryService_1.handleError);
    };
    GalleryService.prototype.deleteSite = function (id) {
        return this.http.delete(this.deleteUrl + id.toString())
            .toPromise()
            .catch(GalleryService_1.handleError);
    };
    GalleryService.handleError = function (error) {
        console.error('An error occurred', error); // for demo purposes only
        return Promise.reject(error.message || error);
    };
    return GalleryService;
}());
GalleryService = GalleryService_1 = __decorate([
    core_1.Injectable(),
...
var core_1 = __webpack_require__(10);
var google_map_kml_layer_1 = __webpack_require__(428);
var google_map_1 = __webpack_require__(432);
var google_map_circle_1 = __webpack_require__(427);
var google_map_info_window_1 = __webpack_require__(387);
var google_map_marker_1 = __webpack_require__(429);
var google_map_polygon_1 = __webpack_require__(430);
var google_map_polyline_1 = __webpack_require__(431);
var google_map_polyline_point_1 = __webpack_require__(388);
var lazy_maps_api_loader_1 = __webpack_require__(394);
var lazy_maps_api_loader_2 = __webpack_require__(394);
var maps_api_loader_1 = __webpack_require__(377);
var browser_globals_1 = __webpack_require__(433);
/**
 * @internal
...
var core_module_1 = __webpack_require__(609);
...
var noop_maps_api_loader_1 = __webpack_require__(613);
...
(function(factory) {
	if (true) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(44), __webpack_require__(368) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	}
...
module.exports = "<ol class=\"breadcrumb\">\n  <li class=\"breadcrumb-item\">LeylineIndex</li>\n  <li class=\"breadcrumb-item active\">广场</li>\n</ol>\n<h1 class=\"page-title\">广场 - <span class=\"fw-semi-bold\">{{activeGroup}} {{activeDomain == '其他域名'?' 其他域名':domLists}} - 第 {{currentPage+1}} 页</span></h1>\n\n<div>\n  <div class=\"clearfix mb-lg {{abc}}\">\n\n    <div class=\"btn-group mr-2\">\n      <button type=\"button\"  (click)=\"getPage(currentPage-1)\" class=\"btn btn-secondary {{currentPage <=0 ? 'disabled' : ''}}\">上一页</button>\n      <div class=\"btn-group\" dropdown>\n        <button id=\"dropdown-btn-three\" class=\"btn btn-secondary\">\n          {{currentPage+1}}\n        </button>\n\n        <button class=\"btn btn-secondary {{currentRange && currentRange.length>0 ? '':'disabled'}}\" dropdownToggle>\n          <i class=\"fa fa-caret-down\"></i>\n        </button>\n\n        <ul dropdownMenu *ngIf=\"currentRange && currentRange.length>0\" role=\"menu\" aria-labelledby=\"dropdown-btn-three\">\n          <li role=\"menuitem\" *ngFor=\"let p of currentRange\">\n            <a class=\"dropdown-item\" (click)=\"getPage(p)\">第{{p+1}}页</a>\n          </li>\n        </ul>\n\n      </div>\n      <button type=\"button\" (click)=\"getPage(currentPage+1)\" class=\"btn btn-secondary {{currentPage >= maxPage ? 'disabled' : ''}}\">下一页</button>\n    </div>\n\n    <div class=\"btn-group mr-2\">\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeGroup == '全部'}\"\n              (click)=\"activeGroupSelected('全部')\">全部</span>\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeGroup == '个站'}\"\n              (click)=\"activeGroupSelected('个站')\">个站</span>\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeGroup == '玩梗'}\"\n              (click)=\"activeGroupSelected('玩梗')\">玩梗</span>\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeGroup == '服务'}\"\n              (click)= \"activeGroupSelected('服务')\">服务</span>\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeGroup == '资讯'}\"\n              (click)= \"activeGroupSelected('资讯')\">资讯</span>\n    </div>\n\n    <div class=\"btn-group mr-2\">\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeDomain == '全部域名'}\"\n              (click)=\"activeDomainSelected('全部域名')\">全部域名</span>\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeDomain == '经典域名'}\"\n              (click)=\"activeDomainSelected('经典域名')\">经典域名</span>\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeDomain == '流行个人域名'}\"\n                    (click)=\"activeDomainSelected('流行个人域名')\">流行个人域名</span>\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeDomain == '萌域名'}\"\n              (click)=\"activeDomainSelected('萌域名')\">萌域名</span>\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeDomain == '其他域名'}\"\n              (click)=\"activeDomainSelected('其他域名')\">其他域名</span>\n    </div>\n\n    <div class=\"btn-group mr-2\">\n      <span class=\"btn btn-default\" [ngClass]=\"{'active': activeOwned == '全部'}\"\n            (click)=\"activeOwnedSelected('全部')\">全部</span>\n        <span class=\"btn btn-default\" [ngClass]=\"{'active': activeOwned == '已认领'}\"\n              (click)=\"activeOwnedSelected('已认领')\">已认领</span>\n    </div>\n\n\n\n    <div class=\"float-right m-b-20\">\n      <div class=\"btn-group\">\n                <span class=\"btn btn-default\" [ngClass]=\"{'active': order == '正序'}\"\n                      (click)=\"sortSelected('正序')\"><i class=\"fa fa-sort-numeric-asc\"></i></span>\n                <span class=\"btn btn-default\"  [ngClass]=\"{'active': order == '倒序'}\"\n                      (click)=\"sortSelected('倒序')\"><i class=\"fa fa-sort-numeric-desc\"></i></span>\n      </div>\n    </div>\n\n\n  </div>\n  <div class=\"bs3-row gallery\" id=\"magnific\">\n    <!--         attr.data-groups=\"{{ item.groups[0] }}\"-->\n    <div *ngFor=\"let item of items\"\n         class=\"bs3-col-md-6 bs3-col-lg-3 bs3-col-12 gallery-item\"\n         attr.data-title=\"{{ item.name }}\"\n    >\n      <figure class=\"figure img-thumbnail\">\n        <a href=\"https://ws4.sinaimg.cn/large/{{item.thumb}}\"><img class=\"figure-img\" src=\"https://ws4.sinaimg.cn/large/{{item.thumb}}\" alt=\"...\"></a>\n        <figcaption class=\"figure-caption\">\n          <h6 class=\"mt-0 mb-xs\">{{item.title |  truncate : 20}}</h6>\n          <ul class=\"post-links\">\n            <li><a href=\"{{item.url}}\">{{item.url  |  truncate : 15}}</a></li>\n\n            <div *ngIf=\"item.meta.description != null\">\n                &nbsp;|&nbsp;{{item.meta.description |  truncate : 10}}\n            </div>\n            <div *ngIf=\"item.meta.description == null\">\n              &nbsp;\n            </div>\n            <a href=\"#\"><span class=\"text-danger\"><i class=\"fa {{item.like ? 'fa-heart' : 'fa-heart-o'}}\"></i> Like</span></a>\n            <a href=\"#\"><span class=\"text-danger\" *ngIf=\"item.owned\"> |  已认领 </span></a>\n\n            <!--\n                        <li><a (click)=\"deleteSite(item)\">删除</a></li>\n                        <li><a href=\"#\">截图</a></li>\n\n                        <li><a (click)=\"addGroup(item,'个站')\">个站</a></li>\n                        <li><a (click)=\"addGroup(item,'资讯')\">资讯</a></li>\n                        <li><a (click)=\"addGroup(item,'服务')\">服务</a></li>\n                        <li><a (click)=\"addGroup(item,'玩梗')\">玩梗</a></li>\n            -->\n          </ul>\n        </figcaption>\n      </figure>\n\n    </div>\n    <div class=\"bs3-col-md-6 bs3-col-lg-3 bs3-col-12 js-shuffle-sizer\"></div>\n  </div>\n</div>\n"
